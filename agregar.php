...
if(isset($_POST['guardar'])){
    ...
    (nombre_producto, descripcion, precio, stock, imagen, categoria, calificacion, descuento, fecha_agregado)
    VALUES
    ('$nombre', '$descripcion', $precio, $stock, '$imagen', '$categoria', $calificacion, $descuento, NOW())";
...
<title>Agregar Producto - MAXIMA ONLINE STORE</title>
    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <select id="categoria" name="categoria" required>
                ...
                <option value="Productos smart">Productos smart</option>
                <option value="Coventra smart">Coventra smart</option>
                <option value="Novedades">Novedades</option>
                <option value="Tecnología">Tecnología</option>
                <option value="Hogar">Hogar</option>
                <option value="Moda">Moda</option>
                <option value="Deportes">Deportes</option>
                <option value="Pastamanías">Pastamanías</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="calificacion" name="calificacion" min="1" max="5" step="0.1" value="4.5" required>
        </div>

        <div class="form-group">
            <label for="descuento">Descuento (%) *</label>
            <input type="number" id="descuento" name="descuento" min="0" max="100" value="0" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="url" id="imagen" name="imagen" placeholder="https://ejemplo.com/imagen.jpg" required>
        </div>
